<?php
    ...
    class EmpresaDAO extends Conexao{
        ...
        public function ConsultarEmpresa(){
            ...
            $comando_sql = 'select id_empresa, telefone_empresa,endereco_empresa from tb_empresa where id_usuario = ? order by nome_empresa ASC';
        ...
        public function AlterarEmpresa($nomeEmpresa, $telefone, $endereco,$idEmpresa){
            if (trim($nomeEmpresa) == '' || trim($telefone) == '' || trim($endereco) == ''|| $idEmpresa=='') {
                return 0;
            } else {
                //return 1;
                $conexao = parent::retornarConexao();
